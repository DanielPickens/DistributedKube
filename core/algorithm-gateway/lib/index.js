...
const start = async (options, distributedkubeApi) => {
...
const _getStats = () => {
    ...
    try {
        ...
        const adapter = props.distributedkubeApi._streamingManager._messageProducer._adapter;
...
const streamMessage = (message, flow) => {
    ...
    try {
        ...
        props.distributedkubeApi.sendMessage(message, flowName);
    }
    catch (e) {
