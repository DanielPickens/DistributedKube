...
class KubernetesApi {
    ...
    async getPodsBySelector(type) {
        return this._client.pods.get({ labelSelector: `type=${type},group=distributedkube` });
    }

    async getWorkerJobs() {
        return this._client.jobs.get({ labelSelector: `type=${PodTypes.WORKER},group=distributedkube` });
    }
