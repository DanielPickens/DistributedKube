...
const { applyEnvToContainer, createImageFromContainer, applyImage: utilsApplyImage } = require('@distributedkube/kubernetes-client').utils;
const { getIngressApiVersion, getIngressBackend, applyVolumeMounts, applyVolumes } = require('@distributedkube/kubernetes-client').utils;
