        ...
        template: {
            ...
            spec: {
                ...
                containers: [
                    {
                        name: ALGORITHM_BUILDS,
                        image: `distributedkube/${ALGORITHM_BUILDS}`,
                        envFrom: [
                            {
                                configMapRef: {
...
const openshiftVolumes = {
    volumeMounts: [
        ...
        {
            name: 'uploads',
            mountPath: '/distributedkube/algorithm-builder/uploads'
        },
        {
            name: 'builds',
            mountPath: '/distributedkube/algorithm-builder/builds'
        },
        {
            name: 'kube',
            mountPath: '/.kube'
...
const openshiftContainer = {
    name: OC_BUILDER,
    image: `distributedkube/${OC_BUILDER}`,
    env: [
        {
            name: 'NAMESPACE',
            valueFrom: {
