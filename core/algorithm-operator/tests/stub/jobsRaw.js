    ...
    items: [
      {
        ...
        metadata: {
          ...
          namespace: 'distributedkube',
          resourceVersion: '18268968',
          selfLink: '/apis/batch/v1/namespaces/distributedkube/jobs/eval-alg-252e3991290315254b66cb8f8aa0f7',
        ...
        spec: {
          template: {
            ...
            spec: {
              containers: [
                {
                  image: 'distributedkube/worker:v1.2.55',
                  imagePullPolicy: 'IfNotPresent',
                  name: 'worker',
                },
                {
                  image: 'distributedkube/algorunner:v1.2.8',
                  imagePullPolicy: 'IfNotPresent',
                  name: 'algorunner',
                }
              ],
              ...
              containers: [
                {
                  env: [
                    ...
                    {
                      name: 'distributedkube_LOG_LEVEL',
                      value: '1'
                    }
                  ],
                  image: 'distributedkube/worker:v1.1.25',
                  imagePullPolicy: 'IfNotPresent',
                  name: 'worker',
                  resources: {},
                  securityContext: {
                ...
                {
                  image: 'distributedkube/algorunner:v1.1.3',
                  imagePullPolicy: 'IfNotPresent',
                  name: 'algorunner',
                  resources: {},
                  terminationMessagePath: '/dev/termination-log',
