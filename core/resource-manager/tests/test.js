...
describe('Test', function () {
    before(async function () {
        ...
        mockery.registerSubstitute('@distributedkube/prometheus-client', `${process.cwd()}/tests/mocks/adapters/prometheus-client-mock.js`);
        mockery.registerSubstitute('@distributedkube/kubernetes-client', `${process.cwd()}/tests/mocks/adapters/kubernetes-client-mock.js`);
