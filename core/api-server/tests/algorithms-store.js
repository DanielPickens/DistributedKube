...
const gitRepo = 'https://github.com/danielpickens/distributedkube';
const distributedkubeRepo = '/repos/danielpickens/distributedkube/commits';
const emptyGit = '/repos/distributedkube/empty/commits';
const fullGit = '/repos/distributedkube/my.git.foo.bar/commits';
...
describe('Store/Algorithms', () => {
    before(() => {
        ...
        nock(baseApi).persist().get(distributedkubeRepo).query(true).reply(HttpStatus.OK, commit.data);
    });
    ...
    describe('/store/algorithms/apply POST', () => {
        describe('Validation', () => {
            ...
            it('should throw validation error of algorithm type cannot be changed', async () => {
                const url = 'https://github.com/distributedkube/my.git.foo.bar';
                const body1 = {
                    name: uuid(),
                    gitRepository: {
                        url
            ...
            it('should delete nullable properties', async () => {
                ...
                const body1 = {
                    ...
                    baseImage: 'distributedkube/image',
                    algorithmEnv: {
                        MY_ENV: 'value'
                    },
                    workerEnv: {
                    ...
                    quotaGuarantee: 5,
                    labels: {
                        'distributedkube.io/key': 'label'
                    },
                    downloadFileExt: 'jpg',
                    annotations: {
                        'distributedkube.io/key': 'annotation'
                    },
                    nodeSelector: {
                        'distributedkube.io/key': 'selector'
                    }
                };
                const body2 = {
                    name: algorithmName,
        ...
        describe('labels and annotations', () => {
            ...
            it('should throw validation error of empty label name', async () => {
                const body = {
                    ...
                    algorithmImage: 'algorithmImage',
                    labels: {
                        'distributedkube.do-main.com/': 'my-val'
                    }
                };
                const options = {
                    uri: applyPath,
            ...
            it('should throw validation error if invalid label key name', async () => {
                const body = {
                    ...
                    algorithmImage: 'algorithmImage',
                    labels: {
                        'distributedkube.do-main.com/NOT_VALID': 'my-value'
                    }
                };
                const options = {
                    uri: applyPath,
            ...
            it('should not throw validation error if empty label value', async () => {
                const body = {
                    ...
                    algorithmImage: 'algorithmImage',
                    labels: {
                        'distributedkube.do-main.com/valid': ''
                    }
                };
                const options = {
                    uri: applyPath,
            ...
            it('should throw validation error if whitespace label value', async () => {
                const body = {
                    ...
                    algorithmImage: 'algorithmImage',
                    labels: {
                        'distributedkube.do-main.com/valid': ' my val '
                    }
                };
                const options = {
                    uri: applyPath,
            ...
            it('should throw validation error if invalid annotation key name', async () => {
                const body = {
                    ...
                    algorithmImage: 'algorithmImage',
                    annotations: {
                        'distributedkube.do-main.com/NOT_VALID': ' '
                    }
                };
                const options = {
                    uri: applyPath,
        ...
        describe('GitHub', () => {
            ...
            it('should throw error of git repository is empty', async () => {
                const url = 'https://github.com/distributedkube/empty';
                const name = uuid();
                const body = {
                    name,
                    gitRepository: {
        ...
        describe('Code', () => {
            it('should succeed to apply algorithm with no changes', async () => {
                const body1 = {
                    name: `my-alg-${uuid()}`,
                    algorithmImage: 'distributedkube/image',
                    env: 'nodejs'
                };
                const body2 = {
                    ...body1
