...
describe('Experiment', () => {
    ...
    describe('delete /experiment', () => {
        ...
        it('should delete experiment with all related data', async () => {
            ...
            const response3 = await storageManager.distributedkube.list({ jobId });
            const response4 = await storageManager.distributedkubeResults.list({ jobId });
            const response5 = await storageManager.distributedkubeMetadata.list({ jobId });
