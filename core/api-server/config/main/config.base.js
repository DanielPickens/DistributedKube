...
config.debugUrl = {
    path: path.join(config.ingressPrefix, 'distributedkube/debug')
};

config.gatewayUrl = {
    path: path.join(config.ingressPrefix, 'distributedkube/gateway')
};
...
config.storageAdapters = {
    ...
    redis: {
        ...
        moduleName: process.env.STORAGE_MODULE || '@distributedkube/redis-storage-adapter'
    },
    fs: {
