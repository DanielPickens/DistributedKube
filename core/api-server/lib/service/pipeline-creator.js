...
const { NodesMap: DAG } = require('@distributedkube/dag');
const { parser, consts } = require('@distributedkube/parsers');
const { pipelineKind, nodeKind, retryPolicy, stateType } = require('@distributedkube/consts');
