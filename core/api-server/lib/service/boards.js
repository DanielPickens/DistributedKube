...
const { boardStatuses } = require('@distributedkube/consts');
...
class Boards {
    ...
    async startTensorboard(options) {
        ...
        const logDir = await storageManager.distributedkubeAlgoMetrics.getMetricsPath(boardInfo);
        const boardReference = uid();
        const boardLink = `distributedkube/board/${boardReference}/`;
        const board = {
            id,
            boardReference,
            boardLink,
    ...
    async startOptunaboard(options) {
        ...
        const boardReference = uid();
        const boardURL = `distributedkube/board/${boardReference}/dashboard`;
        const board = {
            id: jobId,
            boardReference,
            boardLink: boardURL,
