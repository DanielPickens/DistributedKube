...
const BUILD_GUIDE = 'use the distributedkube dashboard or the distributedkube API to follow the build progress';
...
const MESSAGES = {
    ...
    ALGORITHM_PUSHED: 'the algorithm {algorithmName} has been successfully pushed to distributedkube',
