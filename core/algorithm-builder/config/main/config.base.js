...
config.docker = {
    pull: {
        ...
        namespace: process.env.DOCKER_PULL_NAMESPACE || 'distributedkube',
...
config.packagesRepo = {
    ...
    java: {
        ...
        defaultBaseImage: process.env.JAVA_DEFAULT_BASE_IMAGE || 'distributedkube/openjdk11:jre-11.0.8_10-ubuntu'
    }
